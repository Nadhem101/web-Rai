...
const FichesMaintenance = () => {
  ...
  if (isSummaryView) {
    return (
      <div className="flex flex-1 flex-col overflow-auto p-6" style={{ background: 'var(--bg)' }}>
  ...
  return (
    <div className="flex flex-1 flex-col overflow-auto p-4 md:p-6" style={{ background: 'var(--bg)' }}>
      {error && (
